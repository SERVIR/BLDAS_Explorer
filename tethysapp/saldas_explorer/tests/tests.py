...
# from ..app import SaldasExplorer
    ...
    4. Enter tethys test command.
       ...
       See below for specific examples
        ...
        To run all tests across this app:
            Test command: "tethys test -f tethys_apps.tethysapp.saldas_explorer"

        To run all tests in this file:
            Test command: "tethys test -f tethys_apps.tethysapp.saldas_explorer.tests.tests"

        To run tests in the SaldasExplorerTestCase class:
            Test command: "tethys test -f tethys_apps.tethysapp.saldas_explorer.tests.tests.SaldasExplorerTestCase"

        To run only the test_if_tethys_platform_is_great function in the SaldasExplorerTestCase class:
            Test command: "tethys test -f tethys_apps.tethysapp.saldas_explorer.tests.tests.SaldasExplorerTestCase.test_if_tethys_platform_is_great"
...
class SaldasExplorerTestCase(TethysTestCase):
    """
    ...
    def set_up(self):
        ...
        test database creation function here, like so:
            ...
            self.create_test_persistent_stores_for_app(SaldasExplorer)
    ...
    def tear_down(self):
        ...
        stores, you should call the test database destruction function from here, like so:
            ...
            self.destroy_test_persistent_stores_for_app(SaldasExplorer)
    ...
    def test_home_controller(self):
        ...
        response = c.get('/apps/saldas-explorer/')  # The final '/' is essential for all pages/controllers
